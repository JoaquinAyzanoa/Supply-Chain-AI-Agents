"""``POST /approvals/callback``: a person decided on the weekly run."""
...
from sc_core.schema.a2a import SupplierPerformanceResult
...
def run_finished(result: SupplierPerformanceResult, approval_id: int) -> AgentRunFinished:
