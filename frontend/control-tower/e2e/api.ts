...
export async function mockApi(page: Page, state: ApiState): Promise<void> {
  ...
  await page.route("**/api/**", async (route) => {
    ...
    if (path === "/api/settings" && request.method() === "GET")
      return json(route, 200, { version: 0, changed_by: "environment", changed_at: "2026-09-14T00:00:00Z", settings: { model_by_agent: {}, rfq_no_reply_days: [3, 7], po_eta_request_before_days: 5, po_late_days: [1, 4], approval_stale_days: 2, approval_expire_days: 7, max_actions_per_run: 20, auto_send_partner_ids: [], auto_send_kinds: [], ignored_senders: [], internal_senders: [], planning_service_level: null, planning_review_period_days: null, planning_max_coverage_days: null, holding_cost_pct_year: 20, sourcing_top_n: 3, sourcing_deadline_days: 5, sourcing_freight_pct: 5, negotiation_cap_pct: 10, negotiation_max_rounds: 2 } });
